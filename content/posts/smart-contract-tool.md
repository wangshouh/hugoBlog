...
如果读者对于此方面想更加深入的了解，可以选择阅读我之前写的[Foundry教程：编写测试部署ERC-20代币智能合约](https://hugo.wongssh.cf/posts/foundry-with-erc20/)。
...
![EthDis Output](https://acjgpfqbqr.cloudimg.io/_imgur_/7bWkZXQ.png)
