...
![OpCode GAS](https://img.gopic.xyz/93707598f42c435125c76e597f71b8e9.png)

理论上，我们可以通过合约字节码判断出合约操作所需要的`gas`值。当然，如果读者使用了`Foundry`作为智能合约开发工具链，可以在合约代码根目录运行`forge test --gas-report`获得`gas`报告，如下图:

![Foundry Gas Report](https://img.gopic.xyz/085268c1a57225df3cbee23429cff5ac.png)
...
![Transfer Gas](https://img.gopic.xyz/1c369378906b4e986f439f7b626ee2b1.png)
...
![Gas Small Fail](https://img.gopic.xyz/c60b75cf90f4a062cb65bab13ab111e2.png)
...
![Test Console](https://img.gopic.xyz/7c5f169a91a6e6f6292382d3901df6ef.png)
...
![deposit CallData](https://img.gopic.xyz/e63757e270f78ea02c0221a08fad722c.png)
...
![Tx Example](https://img.gopic.xyz/d8efb34de3b43f5d6fabf22190108b78.png)
...
![Base Fee Calc](https://img.gopic.xyz/1c74f515d06a6248dba96dddab985691.png)
...
![BaseFee List](https://img.gopic.xyz/da4f6d11775e878a9b248cb083a4852d.png)

在上图中，我们可以明显考到这一趋势。在`15406535`区块出现了交易Gas为`0`的情况，导致`BaseFee`下降，在下一区块`15406536`则出现了大量交易。

我使用了部分区块的数据绘制了以下图像:

![Gas Block Size](https://img.gopic.xyz/4bcdd78419d10d5ee9644f20e6aa204c.png)
...
![Gas Burn Chart](https://img.gopic.xyz/9d921b07c858f62e3b34dcc9d642f6e4.png)
...
![BlockNative Gas](https://img.gopic.xyz/4918fcc21584a8c41381008e5d62e1d5.png)
...
![MetaMask Edit Gas](https://img.gopic.xyz/3fb286a48816867f1c197a17e833988a.png)

在弹出页面内选择`高级选项`，我们就可以手动调整各个参数，如下图:

![MetaMask Advance](https://img.gopic.xyz/208e9f86a2c2ff2c4a71faf234b05133.png)
