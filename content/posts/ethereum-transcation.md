...
![State with Tx](https://img.gopic.xyz/3cf30c9764d5209801178e963e1f5ff7.png)
...
```
如果一切顺利，读者可以看到如下内容:
![MetaMask API](https://img.gopic.xyz/62fefc63e6ff21d1a32e1588b27a3861.png)
...
![Tx Types](https://img.gopic.xyz/f0f90a3e1b3781c822373519ab230ac5.png)
...
![Tx Add Flow](https://img.gopic.xyz/txAdd.drawio.svg)
...
![AddTxs](https://img.gopic.xyz/addTxs.drawio.svg)
...
![scheduleReorgLoop](https://img.gopic.xyz/scheduleReorgLoop.drawio.svg)
...
```
输入如下图:
![utws input](https://img.gopic.xyz/16165ef03287c0a1f62ed2fa56d147ed.png)

输出如下图:
![utws output](https://img.gopic.xyz/546871eeed9c3dc3e6785630836f2156.png)
...
![Tx Function Flow](https://img.gopic.xyz/txFunction.drawio.svg)
