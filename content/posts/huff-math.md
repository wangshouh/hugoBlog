...
![EVM architecture](https://img.gopic.xyz/f73d395abc15937cf578e211776a1d03.png)
...
![EVM Run](https://img.gopic.xyz/52ee37da7ae51ba6b12ff2c1e5252864.png)

下图展示了 `stack` 栈的作用:

![stack use](https://img.gopic.xyz/SYJBUBS.png)
...
![EVM Memory](https://img.gopic.xyz/7d1f256b96772176981b6f8b7214c175.png)
...
![Contract Storgae](https://img.gopic.xyz/650f95a37c87adb77e1b03d482000ba8.png)
...
![EVM Read](https://img.gopic.xyz/d052cd9454b569a708b3d1a4cf8d275b.png)
...
> 
>  ![EVM Codes JUMPI](https://img.gopic.xyz/aba9c1005a9c96ebf34fd8f949470ac9.png)
...
![Debug Start](https://img.gopic.xyz/3b0e14081332d143ac83e4126c47fdd9.png)

按下 `C` 键跳转到下个 `call` 请求，我们就进入了 `HuffMath.huff` 合约，如下:

![Into HuffMath](https://img.gopic.xyz/87687b84155d1941acc2a505e3141fee.png)


点击 `s` 键，我们就可以进入 `SAFE_MULTI` 函数体，在最上框内我们可以看到与 huff 合约对应的操作码，如下图:

![SAFE_MULTI func](https://img.gopic.xyz/fb7c14adcd5a53d5368cadeab7487025.png)
...
![Jumpi example](https://img.gopic.xyz/c4327c419f56baa5dc1344e78bc5b0d2.png)
