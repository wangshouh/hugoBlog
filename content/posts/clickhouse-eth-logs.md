...
![ERC20 Event](https://img.gopic.xyz/c277aede62a106b8f7071f0b4207d18a.png)
...
![Event Sigs Db](https://img.gopic.xyz/63b85801b53a976212c074175c7ec519.png)
...
![Exact Result](https://img.gopic.xyz/f65e0300ef96bcf3e1d0ad8a15f89f53.png)

其中 `tx.4` 由于其为 `Nested` 导致较难理解，此处我们特别分析，如下:

![nested logs](https://img.gopic.xyz/0b67adf3b6ed40b588648efdb860c1d2.png)
...
![LEFT JOIN Result](https://img.gopic.xyz/2acdb7852d888495daf4f4509f0f8fae.png)
...
![1inch Token List](https://img.gopic.xyz/491b8efb63163a19f0b8cfd5027ba3fc.png)

我们可以看到 JSON 文件地址为以 `ens` 地址，使用 `eth.limo` 网关(即访问 `https://tokens.1inch.eth.limo/` )就可以获得其中的数据。

![Token List Json](https://img.gopic.xyz/29c1d29de9673fe1d9175b3179de5184.png)
...
1. 右键数据库点击 `编辑 连接` 如下图:
	![Step 1](https://img.gopic.xyz/beaa2cc02e30dcb3bb426d61760bca75.png)
1. 点击 `驱动属性` ，如下图:
	![Step 2](https://img.gopic.xyz/12928d446548e87720cfb2162060820a.png)
1. 找到 `session_id` 属性，点击修改值，填入一个 `UUID`
	![Step 3](https://img.gopic.xyz/12928d446548e87720cfb2162060820a.png)
...
![DBeaver special](https://img.gopic.xyz/38f0d9ecb3bcd6e8e6aefa3b3178b422.png)
...
![Etherface Text](https://img.gopic.xyz/c73477506785d6f455d27a3cbfcddc06.png)
...
![WETH online](https://img.gopic.xyz/470489f8515c9b7f31a7516b367af58d.png)
